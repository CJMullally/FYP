...
//This controller manages the Login and Register functionality.
//Auto-generated by ASP.NET and the Identity framework.
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                {
                    string callbackUrl = await SendEmailConfirmationTokenAsync(user.Id, "Resend confirmation email");
