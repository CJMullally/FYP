...
namespace FYPInitial.CustomFilters
{

    // The following code extends the existing Authorisation Attribute to provide custom messages
    ...
    public class AuthLogAttribute : AuthorizeAttribute
    {
        ...
        private void IsUserAuthorized(AuthorizationContext filterContext)
        {
            ...
            if (filterContext.HttpContext.User.Identity.IsAuthenticated)
            {
                ...
                dict.Add("Message", "Sorry, the action you are trying to perform is restricted to administrative members only.");
